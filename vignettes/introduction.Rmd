...
'nwtco' dataset was used to demonstate an example when a cure model is appropriate and 'gsbg' dataset is used to demonstrate an example when a cure model is not appropriate.
...
# Example 2: `gsbg` data set — an example where a cure model may not be appropriate.
